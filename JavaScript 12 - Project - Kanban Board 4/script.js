...
function createTicket(ticketColor, ticketID, ticketTask, fromLocalStorage = false) {
  // IMPLEMENT HERE
...
function handleLock(ticket) {
  ...
  ticketLockIcon.addEventListener("click", function () {
    if (ticketLockIcon.classList.contains(lockClass)) {
      ...
      let ticketID = ticket.querySelector('.ticket-id').innerText;
      let ticketTask = ticketTaskArea.innerText;
...
function handleColor(ticket) {
  ...
  ticketColorBand.addEventListener("click", function () {
    ...
    let ticketID = ticket.querySelector('.ticket-id').innerText;
    let ticketColor = colors[newColorIndex];
